...
void Administrador::pesquisarEventoPorTipo() {
    ...
    while (std::getline(arquivoEventos, linha)) {
        ...
        if (tipo != "PESSOAL" && ((tipo == tipoEvento) && (criador == "ADMIN" || criador == "PROF"))) {   // Verifica se o tipo de evento e o id do usuario existem
...
void Administrador::listarEventosTodos() {
